...
Frontend para el proyecto del Equipo Pulsar.

## Documentación Técnica

### React + TypeScript + Vite

Este proyecto utiliza React con TypeScript en un entorno Vite, proporcionando una configuración mínima para trabajar con React con HMR y reglas de ESLint.
